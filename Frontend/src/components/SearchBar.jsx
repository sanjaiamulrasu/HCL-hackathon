...
export default function SearchBar({ checkIn, checkOut, setCheckIn, setCheckOut, adults, children, setAdults, setChildren }) {
  return (
    <form
      className="mt-10 flex flex-wrap items-end justify-center gap-4 rounded-2xl border border-white/30 bg-white/15 p-6 shadow-xl backdrop-blur-md sm:gap-3"
